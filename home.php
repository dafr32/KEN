<!-- 
    ****************************************************************
    Strona główna dla Nauczyciela
    ---------------------------------------------
    - HEADER
        - Nazwisko i imię oraz aktualny rok szkolny ustawiony przez administratora
        - zmiana hasła
    - MAIN
        -karty menu z podstronami
    ****************************************************************
 -->
    ...
    <main class="mt-5">
        <div class="container">
            <div class="row">
                ...
                <!-- Nadgodziny  -->
                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 wow fadeIn" data-wow-duration="0.6s" data-wow-delay="0.2s">                    
                    <div class="card h-100" >
                        ...
                        <div class="card-footer text-end border-top-0">
                            <a href="nadgodzinyUser.php"><button class="btn btn-primary btn-block">Dalej</button></a>
                        </div>  
                    </div>           
                </div> 

                <!-- Efektywność  -->
                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 wow fadeIn" data-wow-duration="0.6s" data-wow-delay="0.5s">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 wow fadeIn" data-wow-duration="0.6s" data-wow-delay="0.8s">                    
                    <div class="card h-100" >
                ...
                <!-- Nagrody  -->
                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 wow fadeInUp hide" data-wow-duration="2s"  data-wow-delay="0.5s">                    
                        <div class="card h-100" >
                            <img src="images/home2.jpg" class="card-img-top" alt="..." style="height:190px; width: 100%; object-fit:cover">
                            <div class="card-body">
                            ...
                            <div class="card-footer text-end border-top-0">
                                <a href="#"><button class="btn btn-primary btn-block">Dalej</button></a>
                            </div>  
                        </div>           
                </div> 

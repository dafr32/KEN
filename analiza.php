...
<head>
    ...
    <title>Administracja - analiza</title>  
  </head>
      ...
      <div class="container">
        <div class="row py-2">
          <div class="col p-1">
              ...
              <form action="analiza.php" method="POST" class="d-flex mt-3">
                  ...
                  <div class="d-flex flex-column me-3">
                    ...
                    <select name="sem">
                      <option value="pierwszy" <?php if ($semestr == 'pierwszy') echo 'selected'; ?>>pierwszy</option>
          ...
          <div class="col text-center ">
              <h1 class="title">ANALIZA</h1>
          </div>
          
            <!-- KLASY -->
            
            <div class="col p-1 ">
                <form name="frm_klasy" action="analiza.php" method="POST">
                    <!-- klasy 1 -->
  ...
  <script>    
    $(document).ready(function() {        
      $("#listaUzytkownikow li").on("click", function() {
        ...
        $.ajax({
            url: "getdata.php", // Ścieżka do pliku PHP obsługującego żądanie
            type: "GET", // Typ żądania
            data: {id: id_usera, rocznik:$rocznik }, // Przekazanie id jako dane do pliku PHP
            success: function(response) {
                $("#wynik").html(response); // Wyświetlanie odpowiedzi na stronie
            }
        });            
      });
    });
